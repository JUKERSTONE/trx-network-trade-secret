...
export const TRXHeaderPlayer: React.FC<any> = ({
  state,
  handleTogglePlay,
  handlePost,
  handleMenu,
  ...
  console.log('🚀 ~ file: TRXHeaderPlayer.tsx ~ line 88 ~ player', player);

  const title = player.title || 'tap on an artwork to preview';
  const artist = player.artist || 'tap on an artwork to preview a track';
  const image = player.image.uri || 'tap on an artwork to preview a track';
